...
public class EjerciciosExtra<T extends Comparable<T>> {
    ...
    public boolean SonIguales(Listas<T> list1, Listas<T> list2) {
    ...
    public int ExisteElemento(T value, Listas<T> list) {
        count = 0;
    ...
    public int Ocurrencia(T value, Listas<T> list) {
        count = 0;
    ...
    public long Suma(Listas<Integer> list) {
        suma = 0;
        if (list.getElementAt(0) != null)
